...
class StoresController < ApplicationController
  ...
  private
    ...
    def store_params
      params.require(:store).permit(:filename, :name, :contactMethod, :contactId, :foodType, :description, :fromDay, :toDay, :fromHour, :fromMinute, :toMinute, :fromZone, :toHour, :toZone, :tags, :address, :city, :state, :zipcode, :showAddress, :delivery, :country,:user_id,products_attributes: [:filename,:name,:description,:quantity,:price])
    end
end
